...
4. Maintain authenticity and accuracy, avoid generalizations.`},t={name:"Character LoRA - Woman",prompt:`Generate a caption for this image or sequence of images following this format:
...
✓ "an action scene with dynamic movement in the style of s7yle"`},s={name:"Action/Concept LoRA",prompt:`
...
✓ "applied watercolor effect with soft edges"`},i={name:"[I2I] Color Correction",prompt:`Describe the color and lighting changes applied to transform the input image into the output image. Focus on brightness, contrast, saturation, color temperature, and exposure adjustments.
...
✓ "reduced exposure and cooled tones"`},a={name:"[I2I] Composition Edit",prompt:`Describe the compositional changes made to transform the input image into the output image. Focus on cropping, framing, perspective, and spatial arrangement modifications.
...
Instructions: ${o}`):i.videoBase64?(l=[{type:"text",text:`${o}
Follow the instructions to generate a caption for this video.`},{type:"video_url",video_url:{url:i.videoBase64}}],d=`You are a captioning model. You will be given a video and you will need to generate a caption for it.
...
Instructions: ${o}`):(l=[{type:"text",text:`${o}
${i.type==="video"?`These are frames uniformly extracted from a video. Return a single caption to describe the video.`:""}
Follow the instructions to generate a caption.`}],i.dataUrls&&Array.isArray(i.dataUrls)&&l.push(...i.dataUrls.map(e=>({type:"image_url",image_url:{url:e,detail:"auto"}}))),d=`You are a captioning model. You will be given a picture or sequence of video frames and you will need to generate a caption for them.
