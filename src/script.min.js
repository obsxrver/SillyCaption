...
✓ "an action scene with dynamic movement in the style of s7yle"`},n={name:"Action/Concept LoRA",prompt:`
...
`},s={name:"[I2I] Style Transfer",prompt:`Describe the visual transformation from the input image to the output image. Focus on style changes, color palette shifts, artistic techniques, and overall aesthetic differences. Do not describe the input image itself.
...
✓ "applied watercolor effect with soft edges"`},o={name:"[I2I] Color Correction",prompt:`Describe the color and lighting changes applied to transform the input image into the output image. Focus on brightness, contrast, saturation, color temperature, and exposure adjustments.
...
✓ "reduced exposure and cooled tones"`},i={name:"[I2I] Composition Edit",prompt:`Describe the compositional changes made to transform the input image into the output image. Focus on cropping, framing, perspective, and spatial arrangement modifications.
...
✓ "zoomed in and centered the subject"`};return[e,t,n,s,o,i]}function u(){try{const t=localStorage.getItem(o.presets);if(!t)return null;const n=JSON.parse(t);if(!Array.isArray(n))return null;let e=n.filter(e=>e&&typeof e.name=="string"&&typeof e.prompt=="string");console.log(e);for(const t of v())e.find(e=>e.name===t.name)||e.push(t);return e}catch{return null}}function g(e){localStorage.setItem(o.presets,JSON.stringify(e))}function h(t,n){if(!e.presetSelect)return;e.presetSelect.innerHTML="";const s=document.createElement("option");s.value="",s.textContent="— Select —",e.presetSelect.appendChild(s);for(const o of t){const s=document.createElement("option");s.value=o.name,s.textContent=o.name,n&&o.name===n&&(s.selected=!0),e.presetSelect.appendChild(s)}}function he(){try{const t=localStorage.getItem(o.apiKey);t&&(e.apiKey.value=t)}catch{}e.apiKey.addEventListener("input",()=>{try{localStorage.setItem(o.apiKey,e.apiKey.value)}catch{}});try{const t=localStorage.getItem(o.useCustomVllm);t!==null&&(n.useCustomEndpoint=t==="true",e.useCustomVllm&&(e.useCustomVllm.checked=n.useCustomEndpoint))}catch{}try{const t=localStorage.getItem(o.customVllmEndpoint);if(t)if(t.startsWith("http://")||t.startsWith("https://"))try{const s=new URL(t),o=s.hostname+(s.port?":"+s.port:"");n.customEndpointBase=o,e.customVllmEndpoint&&(e.customVllmEndpoint.value=o)}catch{n.customEndpointBase="",e.customVllmEndpoint&&(e.customVllmEndpoint.value="")}else n.customEndpointBase=t,e.customVllmEndpoint&&(e.customVllmEndpoint.value=t)}catch{}try{const t=localStorage.getItem(o.customVllmBearerToken);t&&(n.customBearerToken=t,e.customVllmBearerToken&&(e.customVllmBearerToken.value=t))}catch{}try{const t=localStorage.getItem(o.customVllmUsername);t&&(n.customUsername=t,e.customVllmUsername&&(e.customVllmUsername.value=t))}catch{}try{const t=localStorage.getItem(o.customVllmPassword);t&&(n.customPassword=t,e.customVllmPassword&&(e.customVllmPassword.value=t))}catch{}P(),e.useCustomVllm&&e.useCustomVllm.addEventListener("change",()=>{n.useCustomEndpoint=e.useCustomVllm.checked,P();try{localStorage.setItem(o.useCustomVllm,n.useCustomEndpoint)}catch{}n.useCustomEndpoint&&n.customEndpointBase?j():n.useCustomEndpoint||(t.vllmModels=[],t.vllmConnectionStatus="disconnected",d(),b(),f())}),n.useCustomEndpoint&&n.customEndpointBase&&j(),e.customVllmEndpoint&&e.customVllmEndpoint.addEventListener("input",()=>{const t=e.customVllmEndpoint.value.trim();if(n.useCustomEndpoint&&t){const e=/^((https?:\/\/)?[a-zA-Z0-9.-]+(:[0-9]+)?|[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+:[0-9]+)$/;if(e.test(t)){n.customEndpointBase=t;try{localStorage.setItem(o.customVllmEndpoint,t)}catch{}j()}}}),e.customVllmBearerToken&&e.customVllmBearerToken.addEventListener("input",()=>{const t=e.customVllmBearerToken.value.trim();if(n.useCustomEndpoint){n.customBearerToken=t;try{localStorage.setItem(o.customVllmBearerToken,t)}catch{}}}),e.customVllmUsername&&e.customVllmUsername.addEventListener("input",()=>{const t=e.customVllmUsername.value.trim();if(n.useCustomEndpoint){n.customUsername=t;try{localStorage.setItem(o.customVllmUsername,t)}catch{}}}),e.customVllmPassword&&e.customVllmPassword.addEventListener("input",()=>{const t=e.customVllmPassword.value.trim();if(n.useCustomEndpoint){n.customPassword=t;try{localStorage.setItem(o.customVllmPassword,t)}catch{}}});let s=u();(!s||s.length===0)&&(s=v(),g(s));let i="Character LoRA - Woman";if(localStorage.getItem(o.lastPreset)?i=localStorage.getItem(o.lastPreset):localStorage.setItem(o.lastPreset,i),h(s,i),i){const t=s.find(e=>e.name===i);t&&(e.systemPrompt.value=t.prompt,e.presetName&&(e.presetName.value=t.name))}e.presetSelect&&e.presetSelect.addEventListener("change",()=>{const n=e.presetSelect.value,s=u()||[],t=s.find(e=>e.name===n);if(t){e.systemPrompt.value=t.prompt,e.presetName&&(e.presetName.value=t.name);try{localStorage.setItem(o.lastPreset,t.name)}catch{}}}),e.btnSavePreset&&e.btnSavePreset.addEventListener("click",()=>{const t=(e.presetName?.value||"").trim();if(!t){alert("Enter a preset name");return}const a=(e.systemPrompt?.value||"").trim(),n=u()||[],s=n.findIndex(e=>e.name===t),i={name:t,prompt:a};s>=0?n[s]=i:n.push(i),g(n),h(n,t);try{localStorage.setItem(o.lastPreset,t)}catch{}e.presetSelect&&(e.presetSelect.value=t)}),e.btnDeletePreset&&e.btnDeletePreset.addEventListener("click",()=>{const t=e.presetSelect?.value||"";if(!t)return;const s=u()||[],n=s.filter(e=>e.name!==t);g(n),h(n,""),e.presetName&&(e.presetName.value="");try{const e=localStorage.getItem(o.lastPreset);e===t&&localStorage.removeItem(o.lastPreset)}catch{}})}function p(n){t.running=n,e.btnCaption.disabled=n,e.btnCaptionUncaptioned&&(e.btnCaptionUncaptioned.disabled=n),e.btnCancel.disabled=!n,e.files.disabled=n,e.outputFiles&&(e.outputFiles.disabled=n),e.modelId.disabled=n,e.btnClearAllCaptions&&(e.btnClearAllCaptions.disabled=n)}e.btnClear.addEventListener("click",()=>{if(t.running)return;e.results.innerHTML="",e.progressBar.value=0,e.progressText.textContent="Idle",e.progressText.className="",e.files.value="",e.files.classList.remove("processing"),e.outputFiles&&(e.outputFiles.value="",e.outputFiles.classList.remove("processing")),t.currentItems=[],t.refreshSeq=0,i.clear(),r()}),e.btnClearAllCaptions?.addEventListener("click",()=>{if(t.running)return;const n=new Set;if(t.currentItems&&t.currentItems.length>0)for(const e of t.currentItems)e.card&&(x(e.card),n.add(e.card));e.results.querySelectorAll(".card").forEach(e=>{n.has(e)||x(e)}),r()}),e.btnCancel.addEventListener("click",()=>{t.abortController&&t.abortController.abort(),p(!1),e.progressText.textContent="Cancelled",e.progressText.className="error",e.files.classList.remove("processing"),e.outputFiles&&e.outputFiles.classList.remove("processing")});async function ue(e){const t=typeof e=="string"?(new TextEncoder).encode(e):e,n=await crypto.subtle.digest("SHA-256",t);return new Uint8Array(n)}function M(e){let t=btoa(String.fromCharCode(...e));return t.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}function de(e=64){const t=new Uint8Array(e);return crypto.getRandomValues(t),M(t)}function le(){return window.location.origin+window.location.pathname.replace(/index\.html$/,"")}async function ie(){const e=de(64),t=M(await ue(e));try{localStorage.setItem(o.oauthCodeVerifier,e)}catch{}const n=le(),s=`https://openrouter.ai/auth?callback_url=${encodeURIComponent(n)}&code_challenge=${encodeURIComponent(t)}&code_challenge_method=S256`;window.location.href=s}async function I(t){const a=localStorage.getItem(o.oauthCodeVerifier)||"",n=await fetch("https://openrouter.ai/api/v1/auth/keys",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({code:t,code_verifier:a,code_challenge_method:"S256"})});if(!n.ok){const e=await n.text().catch(()=>"");throw new Error(`OAuth exchange failed: ${e||n.statusText}`)}const i=await n.json(),s=i?.key||i?.api_key||i?.access_token||"";if(!s)throw new Error("No key in OAuth response");try{localStorage.setItem(o.oauthKey,s)}catch{}e.apiKey.value=s;try{localStorage.setItem(o.apiKey,s)}catch{}try{localStorage.removeItem(o.oauthCodeVerifier)}catch{}_()}function H(){try{const e=localStorage.getItem(o.oauthKey);if(e)return e}catch{}return(e.apiKey.value||"").trim()}function oe(){return n.useCustomEndpoint&&n.customEndpoint?n.customEndpoint:n.endpoint}function se(){return n.useCustomEndpoint&&n.customEndpointBase?n.customEndpointBase.startsWith("http://")||n.customEndpointBase.startsWith("https://")?`${n.customEndpointBase}/v1/models`:`http://${n.customEndpointBase}/v1/models`:null}function ee(){try{localStorage.removeItem(o.oauthKey)}catch{}_()}function _(){const n=(()=>{try{return localStorage.getItem(o.oauthKey)}catch{return null}})(),t=!!(n&&n.startsWith("sk-"));e.authStatus&&(e.authStatus.textContent=t?"Signed in":"Signed out",e.authStatus.classList.toggle("ok",t)),e.btnSignIn&&(e.btnSignIn.disabled=t),e.btnSignOut&&(e.btnSignOut.disabled=!t)}e.btnSignIn?.addEventListener("click",()=>{ie()}),e.btnSignOut?.addEventListener("click",()=>{ee()}),async function(){try{const t=new URLSearchParams(window.location.search),e=t.get("code");if(e){await I(e);const t=new URL(window.location.href);t.searchParams.delete("code"),t.searchParams.delete("state"),history.replaceState({},"",t.toString())}}catch(t){console.error(t),e.progressText.textContent="OAuth error: "+(t?.message||String(t))}finally{_()}}();async function w(){if(!e.files||t.running)return;const n=++t.refreshSeq,s=Array.from(e.files.files||[]),o=t.isImageToImageMode?Array.from(e.outputFiles?.files||[]):[];if(s.length===0){if(n!==t.refreshSeq)return;t.currentItems=[],e.results.innerHTML="",i.clear(),e.progressBar.value=0,e.progressText.textContent="Idle",e.progressText.className="",r();return}e.progressText.textContent="Preparing preview...",e.progressText.className="processing",e.progressBar.value=0;try{const{items:a,captionMap:r}=await Z(s,o);if(n!==t.refreshSeq)return;t.currentItems=a,e.results.innerHTML="",i.clear();for(const e of a){const t=L(e);e.card=t,i.set(e.name,{caption:"",error:null})}for(const e of a){const t=c(e.name||"").toLowerCase();if(r.has(t)&&e.card){const n=r.get(t);typeof n=="string"&&n.length>0&&y(e.card,n)}}e.progressText.textContent="Files ready",e.progressText.className="success"}catch(s){if(n!==t.refreshSeq)return;t.currentItems=[],e.results.innerHTML="",i.clear(),e.progressText.textContent="Error preparing files: "+(s?.message||"Unknown error"),e.progressText.className="error"}finally{n===t.refreshSeq&&r()}}async function Z(e,n){const s=new Map,i=[];for(const t of e)if(F(t))try{const e=(await k(t)).replace(/^\uFEFF/,""),n=c(t.name).toLowerCase();s.set(n,e)}catch(e){console.warn("Failed to read caption file",t?.name,e)}else i.push(t);const a=new Map;if(t.isImageToImageMode&&n&&n.length>0)for(const e of n){if(F(e)){try{const n=(await k(e)).replace(/^\uFEFF/,""),t=c(e.name).toLowerCase();s.has(t)||s.set(t,n)}catch(t){console.warn("Failed to read caption file",e?.name,t)}continue}if(!C(e))continue;const t=await O(e);a.set(c(e.name).toLowerCase(),{dataUrl:t,name:e.name})}const o=[];for(const e of i){if(t.isImageToImageMode&&C(e)){const n=c(e.name),t=a.get(n.toLowerCase());if(t){const s=await O(e);o.push({kind:"image-pair",name:n,inputName:e.name,outputName:t.name,inputDataUrl:s,outputDataUrl:t.dataUrl,type:"image-pair"});continue}}if(C(e)){const t=await O(e);o.push({kind:"image",name:e.name,type:e.type,dataUrl:t})}else q(e)&&o.push({kind:"video",name:e.name,type:e.type,dataUrls:null,file:e})}return{items:o,captionMap:s}}e.files?.addEventListener("change",()=>{w()}),e.outputFiles?.addEventListener("change",()=>{w()});function G(e){if(!e)return"";const t=e.querySelector(".caption"),n=e._captionText||t?.querySelector("textarea");return n?n.value||"":t?.textContent||""}function Y(e){if(!e)return!0;const t=e.querySelector(".caption");return!!t?.classList.contains("error")||G(e).trim().length===0}async function z({onlyUncaptioned:s=!1}={}){const c=H();if(!c){alert("Please enter your API key.");return}if(n.useCustomEndpoint){if(!n.customEndpointBase){alert("Please enter a VLLM server IP:port.");return}const e=/^((https?:\/\/)?[a-zA-Z0-9.-]+(:[0-9]+)?|[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+:[0-9]+)$/;if(!e.test(n.customEndpointBase)){alert("Please enter a valid endpoint format (e.g., 192.168.1.100:8000, example.com, or https://example.com).");return}n.customEndpointBase.startsWith("http://")||n.customEndpointBase.startsWith("https://")?n.customEndpoint=`${n.customEndpointBase}/v1/chat/completions`:n.customEndpoint=`http://${n.customEndpointBase}/v1/chat/completions`}const l=e.systemPrompt.value.trim();if(!l){alert("Please enter a system prompt.");return}const j=Array.from(e.files?.files||[]),b=t.isImageToImageMode?Array.from(e.outputFiles?.files||[]):[];if(j.length===0){alert("Please select at least one input image or video file.");return}if(t.isImageToImageMode&&b.length===0){alert("Please select output images for image-to-image mode.");return}(!t.currentItems||t.currentItems.length===0)&&await w();const u=t.currentItems||[];let o=u;if(s&&(o=u.filter(e=>Y(e.card)),o.length===0)){alert("No uncaptioned items to caption.");return}if(o.length===0){alert("No items to caption.");return}const h=parseInt(e.framesPerVideo.value,10),m=parseInt(e.rps.value,20),f=parseInt(e.concurrency.value,20),g=parseInt(e.retryLimit.value,5),v=parseFloat(e.downscaleMp.value);p(!0),e.files.classList.add("processing"),e.outputFiles&&e.outputFiles.classList.add("processing"),t.abortController=new AbortController,e.progressText.className="processing",A(0,o.length);const a=te({rps:m,concurrency:f});let d=0;const _=o.map(n=>async()=>{const s=n.card||L(n);n.card||(n.card=s);const a=s.querySelector(".caption");a?.classList.remove("error"),s._captionText&&(s._captionText.placeholder="Captioning..."),s._btnCopy&&s._btnCopy.classList.add("hidden");try{const o=await N({apiKey:c,model:e.modelId.value,systemPrompt:l,item:n,signal:t.abortController.signal,retryLimit:g,targetMp:v,framesPerVideo:h});y(s,o),i.set(n.name,{caption:o,error:null})}catch(e){S(s,e),i.set(n.name,{caption:"",error:e&&e.message?e.message:String(e)})}finally{d+=1,A(d,o.length),r()}});try{if(await ne(_,a),!t.running)return;e.progressText.textContent="Done",e.progressText.className="success"}catch(t){e.progressText.textContent="Error: "+(t?.message||"Unknown error"),e.progressText.className="error",console.error("Captioning error:",t)}finally{a&&typeof a.dispose=="function"&&a.dispose(),e.files.classList.remove("processing"),e.outputFiles&&e.outputFiles.classList.remove("processing"),p(!1),t.abortController=null}}e.btnCaption?.addEventListener("click",()=>{z({onlyUncaptioned:!1})}),e.btnCaptionUncaptioned?.addEventListener("click",()=>{z({onlyUncaptioned:!0})});function D(e,t,n){return Math.max(t,Math.min(n,e))}function A(t,n){const s=n===0?0:Math.round(t/n*100);e.progressBar.value=s,e.progressText.textContent=`${t}/${n} (${s}%)`}function C(e){return e.type.startsWith("image/")}function q(e){return e.type.startsWith("video/")}function F(e){return!!e&&(!!(e.type&&e.type.startsWith("text/"))||/\.txt$/i.test(e.name||""))}function E(){t.isImageToImageMode?(e.modeLabel.textContent="Image-to-Image",e.modeDescription.textContent="Upload matching input and output images to generate transformation captions"):(e.modeLabel.textContent="Text-to-Image",e.modeDescription.textContent="Generate captions describing images")}function P(){e.customVllmField&&(e.customVllmField.style.display=n.useCustomEndpoint?"block":"none"),e.customVllmBearerTokenField&&(e.customVllmBearerTokenField.style.display=n.useCustomEndpoint?"block":"none"),e.customVllmUsernameField&&(e.customVllmUsernameField.style.display=n.useCustomEndpoint?"block":"none"),e.customVllmPasswordField&&(e.customVllmPasswordField.style.display=n.useCustomEndpoint?"block":"none"),d()}function d(){if(!e.vllmStatusIndicator||!e.vllmStatusTooltip)return;switch(e.vllmStatusIndicator.classList.remove("success","error","hidden"),t.vllmConnectionStatus){case"success":e.vllmStatusIndicator.classList.add("success"),e.vllmStatusTooltip.textContent="VLLM server connected successfully";break;case"error":e.vllmStatusIndicator.classList.add("error"),e.vllmStatusTooltip.textContent="Failed to connect to VLLM server, defaulting to OpenRouter";break;case"connecting":e.vllmStatusIndicator.classList.add("hidden"),e.vllmStatusTooltip.textContent="Connecting to VLLM server...";break;default:e.vllmStatusIndicator.classList.add("hidden"),e.vllmStatusTooltip.textContent="VLLM server disconnected";break}}async function j(){if(!n.useCustomEndpoint||!n.customEndpointBase)return;const s=++t.vllmFetchSeq,e=se();if(!e)return;t.vllmConnectionStatus="connecting",d();try{const i={"Content-Type":"application/json"};if(n.useCustomEndpoint)if(n.customUsername&&n.customPassword){const e=btoa(`${n.customUsername}:${n.customPassword}`);i.Authorization=`Basic ${e}`}else n.customBearerToken&&(i.Authorization=`Bearer ${n.customBearerToken}`);const o=await fetch(e,{method:"GET",headers:i,signal:AbortSignal.timeout(5e3)});if(!o.ok)throw new Error(`HTTP ${o.status}: ${o.statusText}`);const a=await o.json();if(s!==t.vllmFetchSeq)return;const r=a.data||[];if(t.vllmModels=r.filter(e=>e.id&&e.object==="model").map((e,t)=>({...e,originalIndex:t,name:e.name||e.id,id:e.id,supported_parameters:e.supported_parameters||[],architecture:e.architecture||{input_modalities:["image"]}})),t.vllmModels.length>0)t.vllmConnectionStatus="success",d(),K(),f();else throw new Error("No suitable models found on VLLM server")}catch(e){console.error("Failed to fetch VLLM models:",e),t.vllmConnectionStatus="error",t.vllmModels=[],d(),b(),f()}}function K(){b();const n=t.vllmModels.map((e,n)=>({...e,id:e.id,name:`${e.name||e.id} (local)`,displayName:`${e.name||e.id} (local)`,isLocal:!0,originalIndex:t.openRouterModels.length+n}));t.models=[...t.openRouterModels,...n],l();const e=localStorage.getItem(o.selectedModelLocal)||localStorage.getItem(o.selectedModel);e&&t.models.some(t=>t.id===e)&&a(e)}function b(){t.models=t.models.filter(e=>!e.isLocal),l();const s=e.modelId.value,n=t.models.find(e=>e.id===s);if(!n||n.isLocal){const e=localStorage.getItem(o.selectedModelOpenRouter)||localStorage.getItem(o.selectedModel);e&&t.models.some(t=>t.id===e&&!t.isLocal)?a(e):t.openRouterModels.length>0?a(t.openRouterModels[0].id):t.models.length>0&&a(t.models[0].id)}}function V(){const e=t.vllmModels.map((e,n)=>({...e,id:e.id,name:`${e.name||e.id} (local)`,displayName:`${e.name||e.id} (local)`,isLocal:!0,originalIndex:t.openRouterModels.length+n}));t.models=[...t.openRouterModels,...n.useCustomEndpoint?e:[]],l()}function f(){const r=e.modelId.value;if(r&&t.models.some(e=>e.id===r))return;const s=localStorage.getItem(o.selectedModelLocal);if(n.useCustomEndpoint&&s&&t.models.some(e=>e.id===s)){a(s);return}const i=localStorage.getItem(o.selectedModelOpenRouter);if((!n.useCustomEndpoint||!s)&&i&&t.models.some(e=>e.id===i)){a(i);return}const c="qwen/qwen3-vl-30b-a3b-thinking";if(t.models.some(e=>e.id===c)){a(c);return}if(n.useCustomEndpoint){const e=t.models.find(e=>e.isLocal);if(e){a(e.id);return}}t.openRouterModels.length>0?a(t.openRouterModels[0].id):t.models.length>0&&a(t.models[0].id)}function B(){t.isImageToImageMode=e.modeToggle.checked,E(),e.outputFilesField&&(e.outputFilesField.style.display=t.isImageToImageMode?"block":"none"),e.results.innerHTML="",r();const n=u()||v(),s=e.presetSelect?.value||"",i=localStorage.getItem(o.lastPreset)||"",a=s||i;h(n,a)}function O(e){return new Promise((t,n)=>{const s=new FileReader;s.onerror=()=>n(new Error("Failed to read file")),s.onload=()=>t(s.result),s.readAsDataURL(e)})}function k(e){return new Promise((t,n)=>{const s=new FileReader;s.onerror=()=>n(new Error("Failed to read caption file")),s.onload=()=>t(typeof s.result=="string"?s.result:""),s.readAsText(e)})}async function $(n,s){const o=URL.createObjectURL(n);try{const n=document.createElement("video");n.src=o,n.crossOrigin="anonymous",n.muted=!0,await W(n);const r=n.duration||0,i=Array.from({length:s},(e,t)=>(t+1)/(s+1)*r),a=[];for(let s=0;s<i.length;s++)t.running||(e.progressText.textContent=`Extracting video frames... (${s+1}/${i.length})`),a.push(await U(n,i[s]));return a}finally{URL.revokeObjectURL(o)}}function W(e){return new Promise((t,n)=>{const s=()=>n(new Error("Failed to load video"));e.addEventListener("loadedmetadata",()=>t()),e.addEventListener("error",s,{once:!0})})}function U(e,t){return new Promise((n,s)=>{const o=()=>{const t=document.createElement("canvas");t.width=e.videoWidth,t.height=e.videoHeight;const o=t.getContext("2d");o.drawImage(e,0,0,t.width,t.height),t.toBlob(e=>{if(!e){s(new Error("Failed to capture frame"));return}const t=new FileReader;t.onload=()=>n(t.result),t.onerror=()=>s(new Error("Failed to read frame")),t.readAsDataURL(e)},"image/jpeg",.9)};e.currentTime=Math.min(Math.max(t,0),Math.max(e.duration-.01,0)),e.addEventListener("seeked",o,{once:!0})})}function L(n){const o=document.createElement("div");o.className="card";const h=document.createElement("div");h.className="media";const d=document.createElement("div");d.className="left";const v=document.createElement("div"),m=document.createElement("div");m.className="caption";const s=document.createElement("textarea");m.appendChild(s),s.placeholder="Caption...",s.setAttribute("spellcheck","true"),s.setAttribute("autocomplete","off"),s.setAttribute("autocorrect","off"),s.setAttribute("autocapitalize","off"),s.style.resize="none",s.style.overflowY="hidden";function b(){s.style.height="auto";const e=200,t=Math.min(s.scrollHeight,e);s.style.height=t+"px",s.scrollHeight>e?s.style.overflowY="auto":s.style.overflowY="hidden"}if(s.addEventListener("input",function(){if(b(),n&&n.name){const e=i.get(n.name);e?(e.caption=s.value,e.error=null):i.set(n.name,{caption:s.value,error:null})}m.classList.remove("error"),o._btnCopy&&(s.value.trim().length>0?o._btnCopy.classList.remove("hidden"):o._btnCopy.classList.add("hidden")),r()}),s.addEventListener("mousedown",function(e){e.target===s&&(e.offsetX>s.clientWidth-20||e.offsetY>s.clientHeight-20)&&e.preventDefault()}),setTimeout(b,0),n.kind==="image"){const e=document.createElement("img");e.src=n.dataUrl,e.alt=n.name,d.appendChild(e)}else if(n.kind==="image-pair"){const e=document.createElement("div");e.className="image-pair-container",e.style.display="flex",e.style.gap="8px",e.style.width="100%";const t=document.createElement("img");t.src=n.inputDataUrl,t.alt=n.inputName,t.style.flex="1",t.style.maxWidth="50%";const s=document.createElement("img");s.src=n.outputDataUrl,s.alt=n.outputName,s.style.flex="1",s.style.maxWidth="50%",e.appendChild(t),e.appendChild(s),d.appendChild(e)}else if(n.kind==="video"){const t=document.createElement("video");n.file&&(t.src=URL.createObjectURL(n.file)),t.controls=!0,t.muted=!0,t.loop=!0,t.preload="metadata",t.style.maxWidth="100%",t.style.maxHeight="180px",d.appendChild(t);const s=new MutationObserver(e=>{e.forEach(e=>{e.removedNodes.forEach(e=>{e===o&&t.src&&t.src.startsWith("blob:")&&(URL.revokeObjectURL(t.src),s.disconnect())})})});s.observe(e.results,{childList:!0})}const f=document.createElement("div");f.className="meta";const g=document.createElement("div");g.className="meta-left";const p=document.createElement("span");p.className="file-name",p.textContent=`${n.name}`,p.title=n.name,g.appendChild(p);const u=document.createElement("div");u.className="meta-right";const l=document.createElement("button");l.className="btnClearCaption icon-btn",l.innerHTML=`
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        <line x1="18" y1="6" x2="6" y2="18" />
        <line x1="6" y1="6" x2="18" y2="18" />
      </svg>`,l.setAttribute("aria-label","Clear caption"),l.title="Clear caption",l.addEventListener("click",()=>{t.running||x(o)});const a=document.createElement("button");a.className="btnCopy icon-btn hidden",a.innerHTML=`
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
...
Instructions: ${o}`):(d=[{type:"text",text:`${o}
${i.type==="video"?`This image sequence represents frames uniformly extracted from a video from start to end. Please return one caption to describe the video.`:""}
Follow the instructions to generate a caption.`}],i.dataUrls&&Array.isArray(i.dataUrls)&&d.push(...i.dataUrls.map(e=>({type:"image_url",image_url:{url:e,detail:"auto"}}))),h=`You are a captioning model. You will be given a picture or sequence of pictures and you will need to generate a caption for them.
...
Instructions: ${o}`);const m={model:s,messages:[{role:"system",content:h},{role:"user",content:d}]};n.useCustomEndpoint||(m.provider={ignore:["alibaba"],sort:"throughput"},R(s)&&e.reasoningToggle&&e.reasoningToggle.checked&&(m.reasoning={enabled:!0}));const u={"Content-Type":"application/json","HTTP-Referer":"https://obsxrver.pro/SillyCaption","X-Title":"SillyCaption"};if(n.useCustomEndpoint)if(n.customUsername&&n.customPassword){const e=btoa(`${n.customUsername}:${n.customPassword}`);u.Authorization=`Basic ${e}`}else n.customBearerToken&&(u.Authorization=`Bearer ${n.customBearerToken}`);else u.Authorization=`Bearer ${t}`;const c=await fetch(oe(),{method:"POST",headers:u,body:JSON.stringify(m),signal:a});if(!c.ok){const e=await c.text().catch(()=>"");throw new Error(`HTTP ${c.status}: ${e||c.statusText}`)}let l;try{l=await c.text(),l=l.trim()}catch(e){throw new Error(`Failed to read response: ${e.message}`)}let f;try{f=JSON.parse(l)}catch(e){throw new Error(`Failed to parse JSON response: ${e.message}. Response preview: ${l.substring(0,200)}...`)}let r=f?.choices?.[0]?.message?.content;if(!r)throw new Error("No caption returned");if(typeof r=="string"&&r.includes("</think>")){const e=r.lastIndexOf("</think>");e!==-1&&(r=r.substring(e+"</think>".length).trim(),r=r.replace(/^\s+/,""))}if(Array.isArray(r)){const t=r.find(e=>e.type==="text"),e=t?.text||JSON.stringify(r);if(e.includes("</think>")){const t=e.lastIndexOf("</think>");if(t!==-1)return e.substring(t+"</think>".length).trim().replace(/^\s+/,"")}return e}return r}async function ce(){try{const e=++t.openRouterFetchSeq,n=await fetch("https://openrouter.ai/api/v1/models"),s=await n.json();if(e!==t.openRouterFetchSeq)return;t.openRouterModels=s.data.filter(e=>e.architecture&&e.architecture.input_modalities&&e.architecture.input_modalities.includes("image")).map((e,t)=>({...e,originalIndex:t,isLocal:!1})),V(),f()}catch(t){console.error("Failed to fetch models:",t),e.progressText.textContent="Error: Could not load models"}}function T(e,t=null){return e?t&&t.isLocal?"local":e.split("/")[0]:"unknown"}function R(e){const n=t.models.find(t=>t.id===e);return!!n&&!!n.supported_parameters&&n.supported_parameters.includes("reasoning")}function l(){if(!e.modelOptions)return;const s=e.providerFilter?.value||"all",o=(e.modelSearch?.value||"").toLowerCase(),i=e.sortOrder?.value||"chronological";let n=t.models.filter(e=>{const t=T(e.id,e),n=s==="all"||t===s,i=e.id.toLowerCase().includes(o)||e.name&&e.name.toLowerCase().includes(o);return n&&i});if(i==="alphabetical"?n.sort((e,t)=>e.id.localeCompare(t.id)):i==="chronological"&&n.sort((e,t)=>e.originalIndex-t.originalIndex),e.modelOptions.innerHTML="",n.length===0){e.modelOptions.innerHTML='<div class="custom-option">No models found</div>';return}n.forEach(t=>{const n=document.createElement("div");n.className="custom-option",n.dataset.value=t.id,t.id===e.modelId.value&&n.classList.add("selected"),n.innerHTML=`
          <div class="model-name">${t.name||t.id}</div>
          <div class="model-provider">${T(t.id,t)}</div>
        `,n.addEventListener("click",()=>{a(t.id),e.customSelect.classList.remove("open")}),e.modelOptions.appendChild(n)})}function a(n){const s=t.models.find(e=>e.id===n);if(!s)return;e.modelId.value=s.id,e.selectedModelName&&(e.selectedModelName.textContent=s.name||s.id),document.querySelectorAll(".custom-option").forEach(e=>{e.classList.remove("selected")});const i=document.querySelector(`.custom-option[data-value="${CSS.escape(s.id)}"]`);i&&(i.classList.add("selected"),localStorage.setItem(o.selectedModel,s.id),s.isLocal?localStorage.setItem(o.selectedModelLocal,s.id):localStorage.setItem(o.selectedModelOpenRouter,s.id));let a=n.split("/")[0];e.reasoningToggleField&&(R(n)&&(a==="google"||a==="anthropic")?e.reasoningToggleField.style.display="":e.reasoningToggleField.style.display="none")}function me(){if(!e.customSelect||!e.customSelectTrigger)return;e.customSelectTrigger.addEventListener("click",()=>{e.customSelect.classList.toggle("open")}),document.addEventListener("click",t=>{e.customSelect.contains(t.target)||e.customSelect.classList.remove("open")}),e.providerFilter&&e.providerFilter.addEventListener("change",l),e.modelSearch&&e.modelSearch.addEventListener("input",l),e.sortOrder&&e.sortOrder.addEventListener("change",l),e.modeToggle&&e.modeToggle.addEventListener("change",B)}he(),me(),ce(),E()})()