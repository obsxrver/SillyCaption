...
Instructions: ${o}`;else if(i.nativeVideoDataUrl)c=[{type:"text",text:`${o}
This is a video. Please return one caption to describe the video.
Follow the instructions to generate a caption.`},{type:"video_url",video_url:{url:i.nativeVideoDataUrl}}],u=`You are a captioning model. You will be given a video and you will need to generate a caption for it.
...
Instructions: ${o}`;else{const e=i.kind==="video"&&i.dataUrls&&i.dataUrls.length>0;c=[{type:"text",text:`${o}
${e?`This image sequence represents frames uniformly extracted from a video from start to end. Please return one caption to describe the video.`:""}
Follow the instructions to generate a caption.`}],i.dataUrls&&Array.isArray(i.dataUrls)&&c.push(...i.dataUrls.map(e=>({type:"image_url",image_url:{url:e,detail:"auto"}}))),u=`You are a captioning model. You will be given a picture or sequence of pictures and you will need to generate a caption for them.
